...
//	IP_ADDR		DefaultMask;            // Default subnet mask
	...
	BYTE		rs232_databits;
	BYTE		rs232_stopbits;
	BYTE		rs232_handshake;

	BYTE		r1_activity;
	BYTE		r1_framelen;
	BYTE		r1_parity[16];	// string type
	...
	BYTE		acc_host_tout;
	BYTE		acc_retry_cnt;
	BYTE		acc_local_access;
	BYTE		acc_local_msg[32];
	BYTE		acc_busy_msg[32];
	BYTE		acc_failure_msg[32];
	BYTE		acc_prompt_msg[32];

	DWORD		sm_service_time;
	BYTE		sm_sig_control_en;
	BYTE		sm_sig_control_relay;
	BYTE		sm_sig_control_inverse;
	WORD 		sm_sig_control_duration;
	BYTE 		sm_sig_indicator_en;
	BYTE 		sm_sig_indicator_relay;
	BYTE 		sm_sig_indicator_inverse;
	WORD 		sm_sig_indicator_duration;
	BYTE 		sm_sig_done_en;
	BYTE 		sm_sig_done_sensor;
	BYTE 		sm_sig_done_inverse;
	BYTE 		sm_sig_failure_en;
	BYTE 		sm_sig_failure_sensor;
	BYTE 		sm_sig_failure_inverse;
